...
import binarek.robio.registration.domain.person.PersonRepository;
import binarek.robio.registration.domain.robot.RobotId;
import binarek.robio.registration.domain.robot.RobotRepository;
...
import static binarek.robio.registration.domain.team.TeamFetchProperties.DetailsLevel.TEAM;
import static binarek.robio.registration.domain.team.TeamFetchProperties.DetailsLevel.TEAM_BASIC_INFO;
