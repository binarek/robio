...
import binarek.robio.registration.domain.team.*;
import binarek.robio.registration.persistence.common.EntityRepositoryUtil;
import binarek.robio.registration.persistence.common.EntityTableHelper;
...
public class TeamRepositoryImpl implements TeamRepository {
    ...
    private List<TeamRecord> getTeamRecords(@Nullable TeamFetchProperties fetchProperties) {
        return teamTableHelper.getAll(
                EntityRepositoryUtil.getLimit(fetchProperties),
                EntityRepositoryUtil.getOffset(fetchProperties),
                EntityRepositoryUtil.getSort(fetchProperties, teamTableMapper::toField));
    }
